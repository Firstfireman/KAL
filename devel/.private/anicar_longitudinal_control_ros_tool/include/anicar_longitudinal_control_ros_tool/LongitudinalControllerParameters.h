...
#include <anicar_longitudinal_control_ros_tool/LongitudinalControllerConfig.h>
#else
...
namespace private_LongitudinalController {
...
struct LongitudinalControllerParameters {
  ...
  void fromParamServer(){
    ...
    getParam(privateNamespace + "velocity", velocity, double{0.5});
    ...
    testMin<double>(privateNamespace + "velocity", velocity, 0.0);
    testMax<double>(privateNamespace + "velocity", velocity, 2.0);
  ...
  {
    using namespace private_LongitudinalController;
    os << "[" << p.nodeName << "]\nNode " << p.nodeName << " has the following parameters:\n"
      ...
      << "	" << p.privateNamespace << "velocity:" << p.velocity << "\n"
;
    return os;
  }
  ...
  double velocity; /*!< vehicle velocity */
