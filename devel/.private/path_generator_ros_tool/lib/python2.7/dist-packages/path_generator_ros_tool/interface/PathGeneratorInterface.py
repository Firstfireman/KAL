...
inf = float('inf')
param_description = [{'constant': False, 'description': 'Sets the verbosity for this node', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': 'verbosity', 'name': 'verbosity', 'min': None, 'default': 'debug', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_debug', 'min': None, 'default': 'debug', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_info', 'min': None, 'default': 'info', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_warning', 'min': None, 'default': 'warning', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_error', 'min': None, 'default': 'error', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_fatal', 'min': None, 'default': 'fatal', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'define a distance to homogenize sample points', 'pytype': 'double', 'max': 0.2, 'is_vector': False, 'edit_method': '""', 'name': 'input_distance', 'min': 0, 'default': 0.05, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'weight for moving average', 'pytype': 'double', 'max': 1, 'is_vector': False, 'edit_method': '""', 'name': 'weight', 'min': 0, 'default': 0.2, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'output distance between points', 'pytype': 'double', 'max': 0.2, 'is_vector': False, 'edit_method': '""', 'name': 'output_distance', 'min': 0, 'default': 0.02, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'Map frame ID', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'frame_id_map', 'min': None, 'default': 'map', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'File name of rosbag containing /tf record', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'bag_file_name', 'min': None, 'default': None, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Vehicle frame ID', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'frame_id_vehicle', 'min': None, 'default': 'vehicle', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Top camera frame ID', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'frame_id_camera', 'min': None, 'default': 'camera_top', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Stargazer frame ID', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'frame_id_stargazer', 'min': None, 'default': 'stargazer', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'directory to save road map', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'path_to_map', 'min': None, 'default': None, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Cornu::Parameters::ERROR_COST', 'pytype': 'double', 'max': 1000, 'is_vector': False, 'edit_method': '""', 'name': 'error_cost', 'min': 100, 'default': 700, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'Cornu::Parameters::POINTS_PER_CIRCLE', 'pytype': 'double', 'max': 500, 'is_vector': False, 'edit_method': '""', 'name': 'points_per_circle', 'min': 20, 'default': 150, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'Cornu::Parameters::CURVATURE_ESTIMATE_REGION', 'pytype': 'double', 'max': 100, 'is_vector': False, 'edit_method': '""', 'name': 'curvature_estimate_region', 'min': 0, 'default': 30, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'Topic for example subscriber', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'dummy_subscriber_topic', 'min': None, 'default': 'in_topic', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Queue size for example subscriber', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'dummy_subscriber_queue_size', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'Topic for example publisher', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'dummy_publisher_topic', 'min': None, 'default': 'out_topic', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Queue size for example publisher', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'dummy_publisher_queue_size', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}]
subscriber_description = [{'topic_param': 'dummy_subscriber_topic', 'description': 'example subscriber', 'header': None, 'min_frequency_param': None, 'import': 'std_msgs.msg', 'name': 'dummy_subscriber', 'queue_size_param': 'dummy_subscriber_queue_size', 'no_delay': True, 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'scope': 'private', 'type': 'std_msgs::Header'}]
publisher_description = [{'topic_param': 'dummy_publisher_topic', 'description': 'example publisher', 'header': None, 'min_frequency_param': None, 'scope': 'private', 'name': 'dummy_publisher', 'queue_size_param': 'dummy_publisher_queue_size', 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'import': 'std_msgs.msg', 'type': 'std_msgs::Header'}]
...
class PathGeneratorInterface(dict):
    def __init__(self):
