...
get_filename_component(_filename "/home/kal1-4/anicar_ws/src/hector_nav_msgs/srv/GetDistanceToObstacle.srv" NAME_WE)
add_custom_target(_hector_nav_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_nav_msgs" "/home/kal1-4/anicar_ws/src/hector_nav_msgs/srv/GetDistanceToObstacle.srv" "geometry_msgs/Point:geometry_msgs/PointStamped:std_msgs/Header"
)

get_filename_component(_filename "/home/kal1-4/anicar_ws/src/hector_nav_msgs/srv/GetNormal.srv" NAME_WE)
add_custom_target(_hector_nav_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_nav_msgs" "/home/kal1-4/anicar_ws/src/hector_nav_msgs/srv/GetNormal.srv" "geometry_msgs/Point:geometry_msgs/Vector3:geometry_msgs/PointStamped:std_msgs/Header"
)

get_filename_component(_filename "/home/kal1-4/anicar_ws/src/hector_nav_msgs/srv/GetRobotTrajectory.srv" NAME_WE)
add_custom_target(_hector_nav_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_nav_msgs" "/home/kal1-4/anicar_ws/src/hector_nav_msgs/srv/GetRobotTrajectory.srv" "geometry_msgs/PoseStamped:std_msgs/Header:geometry_msgs/Quaternion:geometry_msgs/Point:geometry_msgs/Pose:nav_msgs/Path"
)

get_filename_component(_filename "/home/kal1-4/anicar_ws/src/hector_nav_msgs/srv/GetSearchPosition.srv" NAME_WE)
add_custom_target(_hector_nav_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_nav_msgs" "/home/kal1-4/anicar_ws/src/hector_nav_msgs/srv/GetSearchPosition.srv" "geometry_msgs/Quaternion:geometry_msgs/PoseStamped:geometry_msgs/Pose:std_msgs/Header:geometry_msgs/Point"
)

get_filename_component(_filename "/home/kal1-4/anicar_ws/src/hector_nav_msgs/srv/GetRecoveryInfo.srv" NAME_WE)
add_custom_target(_hector_nav_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_nav_msgs" "/home/kal1-4/anicar_ws/src/hector_nav_msgs/srv/GetRecoveryInfo.srv" "geometry_msgs/PoseStamped:std_msgs/Header:geometry_msgs/Quaternion:geometry_msgs/Point:geometry_msgs/Pose:nav_msgs/Path"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hector_nav_msgs)
  install(CODE "execute_process(COMMAND \"/opt/mrtsoftware/release/lib/mrt-build-tools/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hector_nav_msgs\")")
  # install generated code
  install(
